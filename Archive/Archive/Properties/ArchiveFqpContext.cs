...
public partial class ArchiveFqpContext : DbContext
{
	...
	public virtual DbSet<ФормаОбразования> ФормаОбразованияs { get; set; }
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<Студент>(entity =>
		{
			...
			entity.HasIndex(e => new { e.IdПользователя, e.IdИнститута, e.IdНаправления, e.IdПрофиля, e.IdФормыОбразования, e.IdУровняОбразования, e.ГодОкончания }, "студент_студент_key").IsUnique();
			...
			entity.Property(e => e.IdФормыОбразования).HasColumnName("id_формы_образования");
			...
			entity.HasOne(d => d.IdФормыОбразованияNavigation).WithMany(p => p.Студентs)
				.HasForeignKey(d => d.IdФормыОбразования)
				.OnDelete(DeleteBehavior.Restrict)
		...
		modelBuilder.Entity<ФормаОбразования>(entity =>
		{
			entity.HasKey(e => e.IdФормыОбразования).HasName("форма_образования_pkey");

			entity.ToTable("форма_образования");

			entity.HasIndex(e => e.Название, "форма_образования_название_key").IsUnique();
