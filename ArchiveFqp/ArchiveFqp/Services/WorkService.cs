...
namespace ArchiveFqp.Services
{
	...
	public interface IWorkService
	{
		...
		/// </summary>
        List<string> AbandonedValues { get;}
        /// <summary>
		/// Работы, являющиеся дипломными
		/// </summary>
        List<string> FqpWorks { get;}
	...
	public class WorkService : IWorkService
	{
        ...
        public List<string> AbandonedValues { get => ["Н/Д", "Ожидание поиска..."]; }
        public List<string> FqpWorks { get => ["ВКРБ", "МД"]; }
